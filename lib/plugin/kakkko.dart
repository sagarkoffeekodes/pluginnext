...
class Kakako extends StatefulWidget {
   Kakako({Key? key}) : super(key: key);

  @override
  State<Kakako> createState() => _KakakoState();
}

class _KakakoState extends State<Kakako> {
  ...
  void load() async {
    ...
    await kakaoSignIn.init('664d4641bf77696e4b51a3bc04dd3918');
