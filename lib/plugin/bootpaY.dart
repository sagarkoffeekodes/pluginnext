...
class BootpaY extends StatefulWidget {
  const BootpaY({Key? key}) : super(key: key);

  @override
  State<BootpaY> createState() => _BootpaYState();
}

class _BootpaYState extends State<BootpaY> {
  Payload payload = Payload();
  String _data = ""; // 서버승인을 위해 사용되기 위한 변수

  String get applicationId {
    return Bootpay().applicationId(
        '62739e1f2701800023f6add3',
  ...
  bootpayReqeustDataInit() {
    ...
    payload.androidApplicationId = '59a4d326396fa607cbe75de5'; // android application id
